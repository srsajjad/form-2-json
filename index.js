...
var main = function (form) {
  for (var _len = arguments.length, json = Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++) {
    json[_key - 1] = arguments[_key];
  }
  ...
  return new promise(function (resolve, reject) {
    ...
    resolve(JSON.stringify.apply(JSON, [obj].concat(json)));
  });
};
